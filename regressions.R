...
r1q=lm(V1~I(rank==2)+I(rank==3)+I(rank==4)+I(rank==5)+I(rank==6)+
         I(rank==7)+I(rank==8)+I(rank==9)+I(rank==10),data=datm[datm$decade==1980,])
r2q=lm(V1~I(I(rank==2))+I(I(rank==3))+I(I(rank==4))+I(I(rank==5))+I(I(rank==6))+
         I(I(rank==7))+I(I(rank==8))+I(I(rank==9))+I(I(rank==10)),data=datm[datm$decade==1990,])
r3q=lm(V1~I(I(rank==2))+I(I(rank==3))+I(I(rank==4))+I(I(rank==5))+I(I(rank==6))+
         I(I(rank==7))+I(I(rank==8))+I(I(rank==9))+I(I(rank==10)),data=datm[datm$decade==2000,])

datm$rank=factor(datm$rank)
r1q=lm(V1~relevel(rank,ref="1"),data=datm[datm$decade==2000,])#why the standard errors are all the same?
summary(r1q)
summary(r2q)
summary(r3q)
...
r5=felm(V1~V5+I(V5*I(decade==1990))+I(V5*I(decade==2000))|V2+indyear|0|V2,data=datm)
summary(r1)
summary(r2)
summary(r3)
summary(r4)
